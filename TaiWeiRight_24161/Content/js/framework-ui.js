...
$.loading = function (bool, text) {
    ...
    if (!!text) {
        ...
        $loadingtext.html($JSLanguage.Loadingtext);//数据加载中，请稍后…
    }
...
$.modalOpen = function (options) {
    var defaults = {
        id: null,
        title: $JSLanguage.XTCK,//系统窗口
        width: "100px",
        height: "100px",
        url: '',
        shade: 0.3,
        btn: [$JSLanguage.BtnConfirm, $JSLanguage.BtnClose], //确认  关闭
...
$.modalConfirm = function (content, callBack) {
    top.layer.confirm(content, {
        ...
        title: $JSLanguage.XTTS,//系统提示
        btn: [$JSLanguage.BtnConfirm, $JSLanguage.BtnQuXiao], //确认  取消
        btnclass: ['btn btn-primary', 'btn btn-danger'],
    }, function () {
        callBack(true);
    }, function () {
...
$.submitForm = function (options) {
    var defaults = {
        url: "",
        param: [],
        loading: $JSLanguage.ZZTJSJ,//正在提交数据...
        success: null,
        close: true
    };
    var options = $.extend(defaults, options);
...
$.deleteForm = function (options) {
    var defaults = {
        prompt: $JSLanguage.QDSC,//注：您确定要删除该项数据吗？
        url: "",
        param: [],
        loading: $JSLanguage.ZZSC,//正在删除数据...
        success: null,
        close: true
    };
    var options = $.extend(defaults, options);
